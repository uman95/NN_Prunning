...
model = densenet(in_channel=args.num_channel,depth=args.depth, dataset=args.dataset)
...
newmodel = densenet(in_channel=args.num_channel,depth=args.depth, dataset=args.dataset, cfg=cfg)
